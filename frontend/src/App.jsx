...
function App() {
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      try {
        ...
        const response = await axios.get(`https://frontend-five-psi-94.vercel.app${savedUser.email}`);
        if (response.data) {
  ...
  async function reviewCode() {
    try {
      const response = await axios.post("https://frontend-five-psi-94.vercel.app/ai/get-review", { code });
  ...
  const handleLogin = async (email, password) => {
    try {
      const response = await axios.post("https://frontend-five-psi-94.vercel.app/api/login", { email, password });
  ...
  const handleSignup = async (email, password, role = "user") => {
    try {
      const response = await fetch("https://frontend-five-psi-94.vercel.app/api/signup", {
        method: "POST",
